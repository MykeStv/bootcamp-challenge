...
import org.example.cardgame.generic.GsonEventSerializer;
...
@Configuration
@ComponentScan(value = "org.example.cardgame.business", useDefaultFilters = false,
...
public class ApplicationConfig {
    ...
    @Bean
    public IntegrationHandle integrationHandle(EventStoreRepository repository,
                                               EventPublisher eventPublisher, EventSerializer eventSerializer) {
